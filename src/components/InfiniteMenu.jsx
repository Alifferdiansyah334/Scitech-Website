...
class IcosahedronGeometry extends Geometry {
  constructor() {
    ...
    this.addVertex(
      -1, t, 0, 1, t, 0, -1, -t, 0, 1, -t, 0, 0, -1, t, 0, 1, t, 0, -1, -t, 0, 1, -t, t, 0, -1, t, 0, 1, -t, 0,
      -1, -t, 0, 1,
    ).addFace(
...
class InfiniteGridMenu {
  ...
  #animate(deltaTime) {
    ...
    positions.forEach((p, ndx) => {
      const scale = (Math.abs(p[2]) / this.SPHERE_RADIUS) * 0.6 + 0.4;
      const finalScale = scale * 0.25;
...
export default function InfiniteMenu({ items = [], scale = 1.0 }) {
  ...
  const handleButtonClick = () => {
    ...
    if (activeItem.link.startsWith("http")) window.open(activeItem.link, "_blank", "noopener,noreferrer");
  };
